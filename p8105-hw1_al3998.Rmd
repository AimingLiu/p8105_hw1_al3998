...
When converting logical values into numeric values,the logical value `True` takes the numeric value `1` and `False` takes the numeric value `0`.
...
When converting factor values into numeric ones,the different levels may be converted into `1`,`2` and `3`.
